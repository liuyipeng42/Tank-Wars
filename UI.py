...
def show_number(screen, numbers, number, pos1):
    for i in number:
        if i == '.':
            screen.blit(numbers['dot'], (pos1[0], pos1[1]))
            pos1[0] += 14
        if i == '0':
            screen.blit(numbers['zero'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '1':
            screen.blit(numbers['one'], (pos1[0], pos1[1]))
            pos1[0] += 19
        if i == '2':
            screen.blit(numbers['two'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '3':
            screen.blit(numbers['three'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '4':
            screen.blit(numbers['four'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '5':
            screen.blit(numbers['five'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '6':
            screen.blit(numbers['six'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '7':
            screen.blit(numbers['seven'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '8':
            screen.blit(numbers['eight'], (pos1[0], pos1[1]))
            pos1[0] += 24
        if i == '9':
            screen.blit(numbers['nine'], (pos1[0], pos1[1]))
            pos1[0] += 24
